...
typedef struct
{
    ...
    //通讯数据分析处理接口
    mlu16 (*datagramProcesses[PB_CTRL_DEV_MAX])(mlu8, mlu8 *,mlu16);
...
extern void Pb_plc_socket_init(mlu8 plcx,mlu8 *remoteip, mlu16 remoteport,mlu16 (*datagramProcesses)(mlu8, mlu8 *msg,mlu16 len));
extern mlu8* Pb_plc_txbuf_malloc(mlu8 plcx,mlu16 len);
