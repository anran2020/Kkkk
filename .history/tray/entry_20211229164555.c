...
DevMgr *gDevMgr;
u16 gProtoSoftVer = 1;
u16 gMediumSoftVer = 50;//中位机版本号
u8 gLowProtoVer = 2;//中午能级与下位机的协议版本号
u8 gSmplStoreVer = 1;//采样存储的版本号
...
int mainInit()
{
    ...
    devMgr->chnStaMapMed2Up[ChnStaLowSwStart] = ChnUpStateStart;
    devMgr->chnStaMapMed2Up[ChnStaLowStart] = ChnUpStateStart;
    ...
    devMgr->chnStaMapMed2Up[ChnStaMedProtStopEnd] = ChnUpStateRun;
    devMgr->chnStaMapMed2Up[ChnStaMedProtPauseEnd] = ChnUpStateRun;
    devMgr->chnStaMapMed2Up[ChnStaMedProtStopReq] = ChnUpStateRun; /*这个不会有*/
    devMgr->chnStaMapMed2Up[ChnStaMedProtPauseReq] = ChnUpStateRun; /*这个不会有*/
    devMgr->chnStaMapMed2Up[ChnStaMedStopWait] = ChnUpStateStop;
