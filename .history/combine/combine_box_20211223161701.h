...
extern void pwrbox_init(CmbPwrBoxptr pCBox);
extern MLBool pwrbox_run(CmbPwrBoxptr pCBox);
extern void pwrbox_init(CmbPwrBoxptr pBox,CmbPwrMdlptr pChnl,mlu8 chnlNum,CmbPwrMdlptr pMdl,mlu8 mdlNum);
