...
CmbPwrBoxptr pwrbox_create(mlu8 comx,mlu8 addr,mlu8 chnlNum)
{
	...
	pbox->pnext=nullptr;
	pbox->pMytask=subtask_create(ltimer_create());
	pbox->chnlNum=chnlNum;
	pbox->hdwMdlNum=chnlNum;
...
//
//-----------------------------------------------------------------------------
void pwrbox_init(CmbPwrBoxptr pBox,CmbPwrMdlptr pChnl,mlu8 chnlNum,CmbPwrMdlptr pMdl,mlu8 mdlNum)
{
	pBox->pnext=nullptr;
	pBox->pMytask=subtask_create(ltimer_create());
	pBox->mdl=pChnl;
