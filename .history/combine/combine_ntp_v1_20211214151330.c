...
*  
****************************************************************************/
unsigned char cblntp_clear_all_parallel(void *args)
{
	//u8 i,j;
	u8 j;
	Module_TypeDef *pMdl;
...
/*
	//协议处理者
	ntpMU._CMD_connect_handler=cblntp_connect;
	ntpMU._CMD_workStepInfo_handler=cblntp_receive_workstep;	
	ntpMU._CMD_getStack_handler=cblntp_upload_stack;
	ntpMU._CMD_updateStack_handler=_NULL;
	ntpMU._CMD_controlChnl_handler=_NULL;
	ntpMU._CMD_sample_handler=cblntp_sample;
	...
	ntpMU._CMD_forceJump_handler=cblntp_force_jump;
	ntpMU._CMD_startChnl_handler=cblntp_start_test;
	ntpMU._CMD_stopChnl_handler=cblntp_stop_test;
	ntpMU._CMD_pause_handler=_NULL;
	ntpMU._CMD_continueTest_handler=_NULL;
	ntpMU._CMD_wcsInfo_handler=cblntp_receive_wcsi;
*/
	//ntp 事件消息
