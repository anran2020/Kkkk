...
//----------------------------------------------------------------------------
 typedef   struct CmbPwrChnlItem{
	...
	union{
		...
		mlu8 dataBuffer[Igbt_ChnlDatRecUnit_Cnt][Igbt_ChnlOneDataRec_Len];
		IgbtChnlDataRecord_TypeDef dataRecord[Igbt_ChnlDatRecUnit_Cnt];
	};
