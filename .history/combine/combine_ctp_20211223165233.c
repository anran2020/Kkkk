...
void cbl_ctp_init(void)
{
	...
	ctp_consumer_register(CAN_CARD_1,CTP_MSG_autoConnect,pwrbox_auto_connect);//来自lc的自主联机 

	ctp_consumer_register(CAN_CARD_1,CTP_MSG_autoConnect,pwrbox_sample_data);
}
