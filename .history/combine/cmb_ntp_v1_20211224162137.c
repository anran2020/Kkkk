...
unsigned char cblntp_receive_workstep(void *args)
{
	...
	for(i=0;i<worksteps;i++)
	{
		...
		if(pStepBuf[i*STEP_BYTES+1]>=Igbt_MainWorkStep_Max)
		{
			retFlag=ERR_FLAG;
			break ;
		}
		...
		if(pStepBuf[i*STEP_BYTES+1]==pChnl->workStepRcvCnt)
		{
			n=pChnl->workStepRcvCnt;
				
			pChnl->workStep[n].type=pStepBuf[i*STEP_BYTES+2];
			...
			pChnl->workStep[n].paraTemplt.lPara1.handleWay=pStepBuf[i*STEP_BYTES+11];	
			pChnl->workStep[n].paraTemplt.lPara1.nextStep=pStepBuf[i*STEP_BYTES+12];		
			...
			pChnl->workStep[n].paraTemplt.lPara2.handleWay=pStepBuf[i*STEP_BYTES+21];
			pChnl->workStep[n].paraTemplt.lPara2.nextStep=pStepBuf[i*STEP_BYTES+22];
			...
			pChnl->workStep[n].paraTemplt.lPara3.handleWay=pStepBuf[i*STEP_BYTES+27];
			pChnl->workStep[n].paraTemplt.lPara3.nextStep=pStepBuf[i*STEP_BYTES+28];
			...
			pChnl->workStep[n].paraTemplt.lPara4.handleWay=pStepBuf[i*STEP_BYTES+33];
			pChnl->workStep[n].paraTemplt.lPara4.nextStep=pStepBuf[i*STEP_BYTES+34];	
