...
//
//-----------------------------------------------------------------------------
MLBool ds_tray_file_seek_end(mlu8 trayAddr,mlu32*curWriteLine,mlu32* lastReadLine)
{
...
//
//-----------------------------------------------------------------------------
MLBool ds_tray_file_clear(mlu8 trayAddr)
{
	
	return dsf_clear(trayFile[trayAddr]);
