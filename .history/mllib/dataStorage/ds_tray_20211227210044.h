...
extern MLBool ds_tray_file_seek_end(mlu8 trayAddr,mlu32*curWriteLine);
extern mlu8 ds_tray_file_read_lines(mlu8 traAddr, mlu32 startline,mlu8 lineNum,mlu8*outDatBuf);//行 
//----------------------------------------------------------------------------
//文件不被编译，需要声明以下
//----------------------------------------------------------------------------
#else 
