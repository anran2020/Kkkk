...
extern MLBool ds_tray_write_chache(mlu8 traAddr,mlu8 datNum,mlu8*const pData,mlu32 lastReadLine);//托盘数据写缓存
extern MLBool ds_tray_subtask(void);//拖【按数据存储子任务
extern MLBool ds_tray_file_seek_end(mlu8 trayAddr,mlu32*curWriteLine,mlu32* lastReadLine);//文件移到末尾
