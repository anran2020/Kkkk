...
#ifndef  _NTP_W5100_DEF_H__
#define  _NTP_W5100_DEF_H__
...
//  W5100 defines 
//----------------------------------------------------------------------------
//定义Socket接收缓冲区的大小，可以根据W5100_RMSR的设置修改 
#define S_RX_SIZE 	2048		
#define S_TX_SIZE 	2048


#define CS1_ADDR 	0x81000000 						//section 1

//W5100 Register definition
#define	COMMON_BASE   	(CS1_ADDR+0x00000000)			//Base address，根据需要修改
