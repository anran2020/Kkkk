...
#ifndef  _NTP_W5500_DEF_H__
#define  _NTP_W5500_DEF_H__
...
#define _W5500_CREG_BLOCK 			 0x00 	//< Common register block
#define _W5500_SREG_BLOCK(N) 		(1+4*N) //< Socket N register block
#define _W5500_TXBUF_BLOCK(N)      (2+4*N) //< Socket N Tx buffer address block
#define _W5500_RXBUF_BLOCK(N)      (3+4*N) //< Socket N Rx buffer address block

#define _W5500_OFFSET_INC(ADDR, N) 		(ADDR + (N<<8)) //< Increase offset address
 ...
 */
#define _MR                 (_W5500_IO_BASE_ + (0x0000 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define GAR                (_W5500_IO_BASE_ + (0x0001 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define SUBR               (_W5500_IO_BASE_ + (0x0005 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define SHAR               (_W5500_IO_BASE_ + (0x0009 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define SIPR               (_W5500_IO_BASE_ + (0x000F << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define INTLEVEL           (_W5500_IO_BASE_ + (0x0013 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
//#define IR                 (_W5500_IO_BASE_ + (0x0015 << 8) + (_W5500_CREG_BLOCK << 3))
/**
 * @ingroup Common_register_group
 ...
 */
#define IMR                (_W5500_IO_BASE_ + (0x0016 << 8) + (_W5500_CREG_BLOCK << 3))
...
#define SIR                (_W5500_IO_BASE_ + (0x0017 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define SIMR               (_W5500_IO_BASE_ + (0x0018 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define _RTR                (_W5500_IO_BASE_ + (0x0019 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define RCR                (_W5500_IO_BASE_ + (0x001B << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PTIMER             (_W5500_IO_BASE_ + (0x001C << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PMAGIC             (_W5500_IO_BASE_ + (0x001D << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PHAR                (_W5500_IO_BASE_ + (0x001E << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PSID               (_W5500_IO_BASE_ + (0x0024 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PMRU               (_W5500_IO_BASE_ + (0x0026 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define UIPR               (_W5500_IO_BASE_ + (0x0028 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define UPORTR              (_W5500_IO_BASE_ + (0x002C << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define PHYCFGR            (_W5500_IO_BASE_ + (0x002E << 8) + (_W5500_CREG_BLOCK << 3))

// Reserved			         (_W5500_IO_BASE_ + (0x002F << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0030 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0031 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0032 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0033 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0034 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0035 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0036 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0037 << 8) + (_W5500_CREG_BLOCK << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0038 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define VERSIONR           (_W5500_IO_BASE_ + (0x0039 << 8) + (_W5500_CREG_BLOCK << 3))
 ...
 */
#define Sn_MR(N)           (_W5500_IO_BASE_ + (0x0000 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_CR(N)           (_W5500_IO_BASE_ + (0x0001 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_IR(N)           (_W5500_IO_BASE_ + (0x0002 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_SR(N)           (_W5500_IO_BASE_ + (0x0003 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_PORT(N)         (_W5500_IO_BASE_ + (0x0004 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_DHAR(N)         (_W5500_IO_BASE_ + (0x0006 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_DIPR(N)         (_W5500_IO_BASE_ + (0x000C << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_DPORT(N)        (_W5500_IO_BASE_ + (0x0010 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_MSSR(N)         (_W5500_IO_BASE_ + (0x0012 << 8) + (_W5500_SREG_BLOCK(N) << 3))

// Reserved			         (_W5500_IO_BASE_ + (0x0014 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_TOS(N)          (_W5500_IO_BASE_ + (0x0015 << 8) + (_W5500_SREG_BLOCK(N) << 3))
/**
 * @ingroup Socket_register_group
 ...
 * It is set before OPEN command.
 */
#define Sn_TTL(N)          (_W5500_IO_BASE_ + (0x0016 << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0017 << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x0018 << 8) + (_W5500_SREG_BLOCK(N) << 3)) 
// Reserved			         (_W5500_IO_BASE_ + (0x0019 << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x001A << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x001B << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x001C << 8) + (_W5500_SREG_BLOCK(N) << 3))
// Reserved			         (_W5500_IO_BASE_ + (0x001D << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_RXBUF_SIZE(N)   (_W5500_IO_BASE_ + (0x001E << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_TXBUF_SIZE(N)   (_W5500_IO_BASE_ + (0x001F << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_TX_FSR(N)       (_W5500_IO_BASE_ + (0x0020 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_TX_RD(N)        (_W5500_IO_BASE_ + (0x0022 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_TX_WR(N)        (_W5500_IO_BASE_ + (0x0024 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_RX_RSR(N)       (_W5500_IO_BASE_ + (0x0026 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_RX_RD(N)        (_W5500_IO_BASE_ + (0x0028 << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 * then the carry bit is ignored and will automatically update with the lower 16bits value.
 */
#define Sn_RX_WR(N)        (_W5500_IO_BASE_ + (0x002A << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_IMR(N)          (_W5500_IO_BASE_ + (0x002C << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_FRAG(N)         (_W5500_IO_BASE_ + (0x002D << 8) + (_W5500_SREG_BLOCK(N) << 3))
 ...
 */
#define Sn_KPALVTR(N)      (_W5500_IO_BASE_ + (0x002F << 8) + (_W5500_SREG_BLOCK(N) << 3))

//#define Sn_TSR(N)          (_W5500_IO_BASE_ + (0x0030 << 8) + (_W5500_SREG_BLOCK(N) << 3))
