...
{
	upperNtp.datagramProcess=datProcessPort;
}
//-----------------------------------------------------------------------------
// 函数名：
//-----------------------------------------------------------------------------
...
void upper_datagram_process(USockptr sock)
{
	...
	if(upperNtp.datagramProcess!=nullptr)
	{
		sock->rxDataLen = upperNtp.datagramProcess(sock->pRxBuf, sock->pRxBuf, sock->rxDataLen) - sock->pRxBuf;
	}
...

{
	...
	upperNtp.datagramProcess=nullptr;
