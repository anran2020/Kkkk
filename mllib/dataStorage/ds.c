...
//
//-----------------------------------------------------------------------------
MLBool ds_write_file(DSFilileHandle fhdl,mlu8 datNum,mlu8*datBuf,mlu32 curWLine,mlu32 lastReadLine)
{
	mlu8 i;
	...
	if(fhdl<e_dsf_trayMax)
	{
		return ds_tray_write_chache(fhdl,datNum,datBuf,curWLine,lastReadLine);
	}
